...
{
	//load textures
	Assets::loadTexture(renderer, "Resources\\Ship01.png", "Ship01");
	Assets::loadTexture(renderer, "Resources\\Ship02.png", "Ship02");
	Assets::loadTexture(renderer, "Resources\\Ship03.png", "Ship03");
	Assets::loadTexture(renderer, "Resources\\Ship04.png", "Ship04");
	...
	*/
	...
	bgSpritesClose->setScrollSpeed(-150.0f);
...
void Game::removeActor(Actor* actor)
{
	...
	{
		//Swap to end f vector and pop off (avoid erase copies)
